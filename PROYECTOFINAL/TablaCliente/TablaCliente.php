...
<?php
    ...
    while ($registro = $datos->fetch_assoc())
    {
        ...
        <input class='btn btn-primary' type='submit' name='eliminar_".$registro["idCliente"]."' value='Eliminar'>
    </form>
    <form action='EditarCliente.php' method='post'>
        <input type='hidden' name='idCliente' value='" . $registro["idCliente"] . "'>
        <input class='btn btn-primary' type='submit' name='modificar_".$registro["idCliente"]."' value='Modificar'>
    </form>
        </div>
