...
<?php
    ...
    while ($registro = $datos->fetch_assoc())
    {
        ...
        echo "<td class='table-secondary'>".$registro["motivo"]."</td>";
        ...
        <form action='EliminarCita.php' method='post'>
            <input type='hidden' name='idCita' value='" . $registro["idCita"] . "'>
            <input class='btn btn-primary' type='submit' name='eliminar_".$registro["idCita"]."' value='Eliminar'>
        </form>
        <form action='EditarCita.php' method='post'>
            <input type='hidden' name='idCita' value='" . $registro["idCita"] . "'>
            <input class='btn btn-primary' type='submit' name='modificar_".$registro["idCita"]."' value='Modificar'>
        </form>
        </div>
        </td>";
