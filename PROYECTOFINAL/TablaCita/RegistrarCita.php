      ...
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3">
          ...
          <div class="card-body p-4 p-md-5">
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Registrar Cita</h3>
            ...
            <form action="InsertarDatos.php" method="post">
              ...
              <div class="form-outline mb-4">
                <input type="text" name="motivo" id="form3Example1q" class="form-control" />
                <label class="form-label" for="form3Example1q">Motivo</label>
              </div>
