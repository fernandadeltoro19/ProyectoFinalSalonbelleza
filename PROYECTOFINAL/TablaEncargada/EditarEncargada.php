                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="card rounded-3">
                        <div class="card-body p-4 p-md-5">
                            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Editar Encargada</h3>
                            <?php
                            ...
                            $consulta = "SELECT * FROM encargada WHERE idEncargada = $idEncargada";
                            ...
                            if ($resultado->num_rows > 0) {
                                ...
                                echo '<form action="ModificarEncargada.php" method="post">';
                                ...
                                echo '</div>';
                                echo '<input type="hidden" name="idEncargada" value="' . $idEncargada . '"/>';
                                echo '<button type="submit" class="btn btn-success btn-lg mb-1">Actualizar</button>';
                                echo '</form>';
                            } else {
                                echo '<p>No se encontraron datos para Encargada seleccionada.</p>';
                            }
