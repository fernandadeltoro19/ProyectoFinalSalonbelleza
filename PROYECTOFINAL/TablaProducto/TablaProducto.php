...
<?php
    ...
    while ($registro = $datos->fetch_assoc())
    {
        ...
        echo "<td class='table-secondary'>".$registro["categoria"]."</td>";
        echo "<td class='table-secondary'>".$registro["stock"]."</td>";
        echo "<td class='table-secondary'>".$registro["metodopago_venta"]."</td>";
        echo "<td class='table-secondary'>".$registro["fecha_compra"]."</td>";
        echo "<td class='table-secondary'>
        
        <div class='button-container'>
        <form action='EliminarProducto.php' method='post'>
            <input type='hidden' name='idProducto' value='" . $registro["idProducto"] . "'>
            <input class='btn btn-primary' type='submit' name='eliminar_".$registro["idProducto"]."' value='Eliminar'>
        </form>
        <form action='EditarProducto.php' method='post'>
            <input type='hidden' name='idProducto' value='" . $registro["idProducto"] . "'>
            <input class='btn btn-primary' type='submit' name='modificar_".$registro["idProducto"]."' value='Modificar'>
        </form>
        </div>
