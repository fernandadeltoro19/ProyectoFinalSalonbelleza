...
<?php
    ...
    while ($registro = $datos->fetch_assoc())
    {
        ...
        <form action='EliminarProveedor.php' method='post'>
            <input type='hidden' name='idProveedor' value='" . $registro["idProveedor"] . "'>
            <input class='btn btn-primary' type='submit' name='eliminar_".$registro["idProveedor"]."' value='Eliminar'>
        </form>
        <form action='EditarProveedor.php' method='post'>
            <input type='hidden' name='idProveedor' value='" . $registro["idProveedor"] . "'>
            <input class='btn btn-primary' type='submit' name='modificar_".$registro["idProveedor"]."' value='Modificar'>
        </form>
        </div>
...
<div class="button-containerr">
  <form action="RegistrarProveedor.php" method="get">
