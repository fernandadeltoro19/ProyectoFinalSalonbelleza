...
<?php
    ...
    while ($registro = $datos->fetch_assoc())
    {
        ...
        echo "<td class='table-secondary'>".$registro["precio"]."</td>";
        echo "<td class='table-secondary'>".$registro["duracion"]."</td>";
        echo "<td class='table-secondary'>".$registro["descripcion"]."</td>";
        echo "<td class='table-secondary'>".$registro["metodopago_venta"]."</td>";
        ...
        <form action='EliminarServicio.php' method='post'>
            <input type='hidden' name='idServicio' value='" . $registro["idServicio"] . "'>
            <input class='btn btn-primary' type='submit' name='eliminar_".$registro["idServicio"]."' value='Eliminar'>
        </form>
        <form action='EditarServicio.php' method='post'>
            <input type='hidden' name='idServicio' value='" . $registro["idServicio"] . "'>
            <input class='btn btn-primary' type='submit' name='modificar_".$registro["idServicio"]."' value='Modificar'>
        </form>
        </div>
              </td>";
...
<div class="button-containerr">
  <form action="RegistrarServicio.php" method="get">
