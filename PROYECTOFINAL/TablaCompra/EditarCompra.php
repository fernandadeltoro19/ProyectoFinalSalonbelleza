                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="card rounded-3">
                        <div class="card-body p-4 p-md-5">
                            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Editar Compra</h3>
                            <?php
                            ...
                            if ($resultado->num_rows > 0) {
                                ...
                                echo '<label class="form-label" for="form3Example1q">MetodoPago</label>';
                                echo '</div>';
                                echo '<div class="form-outline mb-4">';
                                echo '<input type="text" name="numerocompra" id="form3Example1q" class="form-control" value="' . $registro['numerocompra'] . '"/>';
                                echo '<label class="form-label" for="form3Example1q">Numero Compra</label>';
                                echo '</div>';
                                ...
                                echo '<p>No se encontraron datos para Compra seleccionada.</p>';
                            }
