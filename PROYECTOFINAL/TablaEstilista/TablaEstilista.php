...
<?php
    ...
    $consulta= "SELECT estilista.*, encargada.nombre AS nombre_encargada, cliente.nombre AS nombre_cliente
    from estilista
    ...
    <th scope=col>Nombre Encargada</th>
    ...
    while ($registro = $datos->fetch_assoc())
    {
        ...
        echo "<td class='table-secondary'>".$registro["edad"]."</td>";
        echo "<td class='table-secondary'>".$registro["nombre_encargada"]."</td>";
        echo "<td class='table-secondary'>".$registro["nombre_cliente"]."</td>";
        echo "<td class='table-secondary'>
            
        <div class='button-container'>
        <form action='EliminarEstilista.php' method='post'>
            <input type='hidden' name='idEstilista' value='" . $registro["idEstilista"] . "'>
            <input class='btn btn-primary' type='submit' name='eliminar_".$registro["idEstilista"]."' value='Eliminar'>
        </form>
        <form action='EditarEstilista.php' method='post'>
            <input type='hidden' name='idEstilista' value='" . $registro["idEstilista"] . "'>
            <input class='btn btn-primary' type='submit' name='modificar_".$registro["idEstilista"]."' value='Modificar'>
        </form>
        </div>
